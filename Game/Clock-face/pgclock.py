...
while 1:
    ...
    dc = str(now.time())[0:8]   #create digital clock string
    ...
    dcp = pygame.font.Font(None,40).render(dc, 1, black) #convert digital clock string to pygame surface
    screen.blit(dcp, (43.5, 197.5)) #print digital clock
